  ...
  return (
    <div style={{ width: 'min(1120px, calc(100% - 36px))', margin: '0 auto' }}>
      <div style={{ padding: 'clamp(42px,7vw,78px) 0 28px' }}>
        ...
        {release.category && (
          <p className="section-label">{release.category}</p>
        )}
      ...
      >
        ...
        >
          ...
          <p style={{ color: 'rgba(255,255,255,0.82)', fontSize: '0.9rem' }}>
            This release is an official communication from the Berkeley City
            Police Department, State of Nova.
          </p>
          <hr
            style={{
              border: 'none',
